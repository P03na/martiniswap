    ...
    <StyledStepCard width={['280px', '330px', '380px']}>
      <StepCardInner height="auto">
        ...
        <AllocationGrid>
          ...
          <AllocationMatch color="#BDC2C4" text={t('Treasury')} />
          <Text textAlign="right" bold>
            20%
          </Text>
        </AllocationGrid>
        ...
        <Flex flex="2" flexDirection="column">
          ...
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle">
                {t(
                  '5% of the treasury is added to lottery rounds over the course of a week. This BNB is of course also included in rollovers! Read more in our guide to ',
                )}
                <InlineLink href="https://docs.pancakeswap.finance/tokenomics/cake/cake-tokenomics">
                  {t('MartiniSwap Tokenomics')}
                </InlineLink>
              </Text>
            </li>
          </BulletList>
        ...
        <Flex maxWidth="300px" flexDirection="column">
          ...
          <Text>
            ...
            <InlineLink href="https://docs.pancakeswap.finance/products/lottery/lottery-guide">
              {t('how to play the MartiniSwap lottery!')}
            </InlineLink>
          </Text>
        </Flex>
      </Flex>
